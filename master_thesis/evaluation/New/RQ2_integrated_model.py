...
Research Question 2: How each submodels interact when combined into one model?
...
x0PSB = {
    ...
    "P": 0.0327,  # total Soluble Reactive Phosphorus/total P available for uptake (Mei et al 2023)
}  # concentration in [g m-3]
...
# Rice model
n_rice = 127980  # number of plants using 2:1 pattern
...
# Initial disturbance
#phytoplankton
dvs_d_pond = {0: 0.6, 0.4: 0.52, 0.65:0.55, 1: 0.6, 2:0}
def get_pd(dvs):
    "Function to get pond depth values for given DVS"
    return np.inter
dphy = {
    ...
    "SP": np.array([tsim, np.full((tsim.size,), 0.0327)]).T,
}
