...
class Rice(Module):
   ...
   def diff(self, _t, _x0):
       ...
       k_lv_N_area = self.p['k_lv_N_area']  # [kg N kg leaves-1] fraction of N in leaves on weight basis
       k_Nst = 0.5*k_lv_N_area        # [kg N kg stems-1] fraction of N in stems on weight basis
