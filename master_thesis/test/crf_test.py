...
#Instantiate object:
crf1 = CRF(tsim, dt, x0, p, n_fish[0], n_rice[0])
crf2 = CRF(tsim, dt, x0, p, n_fish[0], n_rice[0])

#First cycle
ycrf1 = crf1.run_simulation(tspan, d1, u, pond_volume)

#Second cycle
ycrf2 = crf2.run_simulation(tspan, d2, u, pond_volume)
...
# Using the function
ycrf = concatenate_simulation_data(ycrf1, ycrf2)

t_ = np.linspace(0, 241, 241+1)
#fish
Mfish = ycrf['Fish']['Mfish']/pfish['k_DMR']
