...
the soils are under flooded conditions, similar to integrated rice and fish farming system.
Therefore, flooding factor f_F is multiplied with alpha_P, beta_P, and alpha_K.

(Harvest Index, to differentiate be)
...
class QUEFTS(Module):
    ...
    Step 2: Calculate Actual Uptake of N, P, and K
    Ui =
    ...
    p : dictionary of scalars
        ...
        ======  =============================================================
        'HI'    [-] Harvest Index
        'DMg'    [kg/ha] grain dry matter production
        'DMs'    [kg/ha] straw dry matter production
    ...
    def __init__(self,tsim,dt,x0,p):
        ...
        # Convert state variables to lists if they are not already
    ...
    def diff(self,_t,_x0):
        ...
        ##If there is high variability of HI 
        ## uptake of nutrient based on the sum of nutrients in grains (g) and straws (s)
        # UN = DMg*XgN+DMs*XsN
        # UP = DMg*XgP+DMs*XsP
        # UK = DMg*XgK+DMs*XsK
