...
plt.annotate('DVS=0.4', xy=(32.5, y_min), xytext=(32.5, y_min),
              fontsize=12, ha='center')
plt.axvline(x=45.1355, color='b', linestyle='--', linewidth=1)
plt.annotate('DVS=0.65', xy=(45.1355, 0), xytext=(45.1355, 0.1),
              fontsize=12, ha='center')
plt.axvline(x=63.5, color='b', linestyle='--', linewidth=1)
plt.annotate('DVS=1', xy=(63.5, 0), xytext=(63.5, y_min),
              fontsize=12, ha='center')
plt.axvline(x=119, color='b', linestyle='--', linewidth=1)
plt.annotate('DVS=2', xy=(119, 0), xytext=(119, y_min),
              fontsize=12, ha='center')
plt.xlabel(r'time [d]')
plt.ylabel(r'DVS [-]')
plt.text(0, 2, 'x=Day 0', ha='center')
plt.text(32.5, 2, 'x ~ Day 32.5', ha='center')
plt.text(45.1355, 1.4, 'x ~ Day 45', ha='center')
