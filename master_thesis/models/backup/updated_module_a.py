...
class Module():
    ...
    def restart(self, new_x0, tspan, d=None, u=None):
        """
        Resets the initial conditions to new_x0 and resumes the simulation.
        ...
        d : dictionary, optional
            Disturbances.
        u : dictionary, optional
            Controlled inputs.
        """
        self.x0 = copy.deepcopy(new_x0)  # Reset initial conditions
        result = self.run(tspan, d, u)   # Resume simulation with new initial conditions
        return result
