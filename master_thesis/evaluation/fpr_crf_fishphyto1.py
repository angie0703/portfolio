...
plt.text(29, 2, 'x ~ Day 29', ha='center')
plt.text(40, 1.4, 'x ~ Day 40', ha='center')
plt.text(55, 2, 'x ~ Day 55', ha='center')
plt.text(101, 2, 'x ~ Day 101', ha='center')
plt.grid(True, which='both', linestyle='--', linewidth=0.5)
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)

plt.figure(13)
plt.bar('Rice', Mgr*0.6, color='orange')
