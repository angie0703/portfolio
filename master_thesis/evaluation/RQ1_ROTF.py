...
make sequence with fishpond then rice
output of fishpond become disturbances
when t =... output of fishpond become input for rice model
The output of fishpod stored in a variable and become input for rice model

tiap mulai cycle baru, ikutin kapan tanggal mulainya
