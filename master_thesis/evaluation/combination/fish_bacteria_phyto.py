# -*- coding: utf-8 -*-
"""
Created on Tue Apr  9 12:56:30 2024
...
Norgf = 5 #N content in organic fertilizers -> pupuk apa yang biasa dipakai di Indonesia, berapa kandungan N dan P dalam pupuk organik 
x0DB['S'] = x0DB['S'] + Norgf
...
plt.figure(1)
plt.plot(t, f_fed, label = 'fish feed intake rate')
plt.plot(t, f_N_prt, label = 'N content in faeces')
plt.plot(t, f_P_prt, label = 'P content in faeces')
plt.plot(t, f_TAN, label = 'TAN concentration')
plt.plot(t, f_P_sol, label = 'P content in urine')
plt.xlabel(r'$time\ [d]$')
plt.ylabel(r'$flow rate\ [g day-1]$')
plt.title("Flow rate in Fish growth")
...
plt.figure(3)
plt.plot(t, f1, label = 'Growth')
plt.plot(t, f2, label = 'Natural mortality')
plt.plot(t, f3, label = 'Death intraspecific competition')
plt.plot(t, f4, label = 'Total nutrient available for uptake')
plt.plot(t, f5, label = 'nutrient consumption')
plt.xlabel(r'$time\ [d]$')
plt.ylabel(r'$flow rate\ [mg day-1]$')
plt.title("Flow rate in Phytoplankton Growth")
plt.legend()
plt.show()